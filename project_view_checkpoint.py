from PyQt6.QtWidgets import QWidget, QVBoxLayout, QTableWidget, QPushButton, QFileDialog, QTableWidgetItem, QHeaderView, QLineEdit, QHBoxLayout,QLabel,QMessageBox,QMenu,QInputDialog, QDialog
...
def read_project_info(folder_path):
    ...
    if os.path.isfile(project_info_path):
        ...
        # Check if the init_file is a string and ends with UI.php
...
class ProjectView(QWidget):
    ...
    def validate_and_apply_rules_in_project(self, file_path, rules_mapping, rules_dict):
        try:
            ...
            if rule_file:
                ...
                return ["No rule file found for this file."]
        except Exception as e:
    ...
    def validate_files(self, project_path, rules_mapping, rules_dict):
        try:
            ...
            for file_path in files_to_validate:
                ...
                errors = self.validate_and_apply_rules_in_project(file_path, rules_mapping, rules_dict)
                if errors:
                    self.files_with_errors[file_path] = errors
                    print('files with errors are', self.files_with_errors)
