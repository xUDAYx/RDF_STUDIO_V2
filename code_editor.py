...
import json
import os,sys
from PyQt6.QtWidgets import QMainWindow, QHBoxLayout,QVBoxLayout, QWidget, QSplitter, QTreeView, QPlainTextEdit, QToolBar, QFileDialog, QToolButton, QTabWidget, QApplication, QMessageBox,  QPushButton, QTextEdit,QScrollBar
...
class CodeEditor(QMainWindow):
    ...
    def check(self):
        folder_path = r"C:\xampp\htdocs\abc"
        self.project_view.populate_tables(folder_path)
